<template>
  ...
  <div class="container">
    ...
    <el-table height="550px" border size="small" :data="tableData" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="有效标识" prop="flag"></el-table-column>
      <el-table-column label="创建时间" prop="createTime"></el-table-column>
      <el-table-column label="创建人ID" prop="createUserid"></el-table-column>
      <el-table-column label="修改时间" prop="updateTime"></el-table-column>
      <el-table-column label="修改人ID" prop="updateUserid"></el-table-column>
      ...
      <el-table-column label="工厂ID" prop="factoryId"></el-table-column>
  ...
  <el-dialog title="添加产品" v-model="centerDialogVisible">
    <el-form id="add-product" label-width="80px" :model="registerForm">
      ...
      <el-form-item prop="factoryId" label="工厂ID">
        <el-input name="factoryId"  v-model="registerForm.factoryId"></el-input>
      </el-form-item>
  ...
  <el-dialog title="编辑" v-model="editVisible">
    <el-form :model="editForm">
      ...
      <el-form-item prop="factoryId" label="工厂ID">
        <el-input name="factoryId"  v-model="editForm.factoryId"></el-input>
      </el-form-item>
    </el-form>
    <template #footer>
      <span class="dialog-footer">
